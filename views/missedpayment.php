    ...
    <div class="row" style="margin: 1%;">
        ...
        <div class="col-sm-12">
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="#"><span style="color:darkgreen;">All Missed Payments</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="redlistedcustomers"><span style="color:red;">Red Listed Customers</span></a>
                </li>
            </ul>
            <div class="row" style="margin: 1%;">
                <div class="col-sm-12">
